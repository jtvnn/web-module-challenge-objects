...
*/
console.log(createMenuItem('Japanese', 10, 'dinner'));
console.log(createMenuItem('Chinese', 8, 'lunch'));
...
export const burger = {
  ...
  discount: function(string){
    ...
    if(string === 'teacher' || string === 'student'){
      return discountPrice = this.price - (this.price * .25);
    }else{
      return discountPrice = this.price - (this.price * .1);
    }
  }
}
...
*/
reviews.push({name: "Jason", rating: 4, feedback: "Absolutely the best!"});
console.log(reviews);
